class CardClass {
  ...
  CardClass(int CardNumber, int TempCardSuite) {
    ...
    Imagename=CardSuite+CardName+".png";
    println(Imagename);
    CardImage=loadImage(Imagename);
    FaceDown=loadImage("b1fv.png");
...
//      text(CardValue, CardX, CardY+45);
      image(CardImage,CardX-10,CardY-20,CardWidth,CardHeight);
    }
    else {
//      fill(0, 0, 0);
//      rect(CardX-10, CardY-20, CardWidth, CardHeight);
      image(FaceDown,CardX-10,CardY-20,CardWidth,CardHeight);
    }
  }
}
